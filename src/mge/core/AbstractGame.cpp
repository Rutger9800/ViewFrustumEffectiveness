...
void AbstractGame::_initializeWindow() {
	...
	_window = new sf::RenderWindow(sf::VideoMode(config::SCREENX, config::SCREENY), "My Game!", sf::Style::Default, sf::ContextSettings(24, 8, 0, 3, 3));
...
void AbstractGame::run()
{
	...
	//settings to make sure the update loop runs at 120 fps
	sf::Time timePerFrame = sf::seconds(1.0f / 360.0f);
